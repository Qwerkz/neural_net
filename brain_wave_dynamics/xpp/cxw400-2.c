...
double lambdaei=.05;
double lambdaii=.05;
double pee=.35,pei=5,pie=1,pii=5;
int c[1000][500];
double w[1000][500];
double drand48();
int nc[500];
...
main()
{
  ...
  fp=fopen("cxee2.tab","w");
  wt=fopen("wxee2.tab","w");
  makecon(400,400,lambdaee,pee,1);
  fp=fopen("cxei2.tab","w");
  wt=fopen("wxei2.tab","w");
  makecon(80,400,lambdaei,pei,0);
  fp=fopen("cxie2.tab","w");
  wt=fopen("wxie2.tab","w");
  makecon(400,80,lambdaie,pie,1);
  fp=fopen("cxii2.tab","w");
  wt=fopen("wxii2.tab","w");
